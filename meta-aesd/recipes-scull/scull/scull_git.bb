...
do_install () {
    ...
    install -m 0644 scull.ko ${D}${base_libdir}/modules/${KERNEL_VERSION}/kernel/drivers/char/

	install -d ${D}${sysconfdir}/init.d
	install -m 0755 ${WORKDIR}/scull-init.sh ${D}${sysconfdir}/init.d
	install -m 0755 ${S}/scull_load ${D}${sysconfdir}/init.d
	install -m 0755 ${S}/scull_unload ${D}${sysconfdir}/init.d
}
